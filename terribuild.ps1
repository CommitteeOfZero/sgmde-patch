...
$product_name = "Steins;Gate My Darling's Embrace Improvement Patch"
...
{
    $patches = gci .\sgmde-script-patches\$($script.Name).*.vcdiff | Sort
...
.\sc3tools\target\release\sc3tools.exe replace-text temp\patched_edited_script_archive\*.SCX sgmde-scripts\*.txt steinsgatemde
